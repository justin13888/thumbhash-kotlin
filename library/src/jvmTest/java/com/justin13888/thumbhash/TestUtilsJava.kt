 ...
 */
fun generateRandomImage(width: Int, height: Int): ByteArray {
 ...
 */
fun areRgbaColorsEqual(a: ThumbHash.RGBA, b: com.madebyevan.thumbhash.ThumbHash.RGBA): Boolean {
    val epsilon = 0.0001f
 ...
 */
fun areImagesEqual(a: ThumbHash.Image, b: com.madebyevan.thumbhash.ThumbHash.Image): Boolean {
